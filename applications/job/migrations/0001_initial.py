    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_code', models.UUIDField(default=uuid.UUID('d1fb3783-0220-4e53-9e6d-3209d71f760b'))),
                ('complete_code', models.UUIDField(default=uuid.UUID('96925c5a-4508-4592-9cc6-ef841baaa26a'))),
                ('cancel_code', models.UUIDField(default=uuid.UUID('a76a4591-ad0d-4470-94eb-73e42f5eb7ce'))),
